      ...
      <Table>
        ...
        <TableBody>
          {clientes.map((cliente) => (
            ...
            >
              <TableCell className="px-6 py-2 text-sm font-medium text-neutral-900">{cliente.id}</TableCell>
              ...
              <TableCell className="px-6 py-2 text-sm text-neutral-900 font-medium">{cliente.nombre}</TableCell>
              <TableCell className="px-6 py-2 text-sm text-neutral-600">{cliente.direccion}</TableCell>
              <TableCell className="px-6 py-2 text-sm text-neutral-600 font-mono">{cliente.cuit}</TableCell>
              <TableCell className="px-6 py-2 text-sm text-neutral-600">{cliente.telefono}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
